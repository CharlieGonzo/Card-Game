...
import org.example.cardgame24.util.GameManager;
...
public class HelloController implements Initializable {
    ...
    void findSolution(ActionEvent event) {
        if(currentHintIndex > manager.getCurrentEquation().length()){
    ...
    /**
     * Used this method when implementing Gemini. But Ai was giving me issues with inconsistent answers.
     * @return
     */
