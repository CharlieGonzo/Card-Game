...
/**
 * This class implements methods to brute force a solution for the card game. This uses the exp4j libary.
 */
public class EquationSolver {
    ...
    public static String solve(Integer[] inputNums) {
       ...
       return goThroughPermutations(permutations);
    }

    private static String goThroughPermutations(List<double[]> permutations) {
